...
public final class SpiderModel extends Model {
	...
	public final void render(float var1, float var2, float var3, float var4, float var5, float var6) {
		...
		var5 = -(MathHelper.cos(var1 * 0.6662F * 2.0F + MathHelper.PI) * 0.4F) * var2;
		float var7 = -(MathHelper.cos(var1 * 0.6662F * 2.0F + MathHelper.HALF_PI) * 0.4F) * var2;
		float var8 = -(MathHelper.cos(var1 * 0.6662F * 2.0F + MathHelper.ONE_AND_HALF_PI) * 0.4F) * var2;
		float var9 = Math.abs(MathHelper.sin(var1 * 0.6662F) * 0.4F) * var2;
		float var10 = Math.abs(MathHelper.sin(var1 * 0.6662F + MathHelper.PI) * 0.4F) * var2;
		float var11 = Math.abs(MathHelper.sin(var1 * 0.6662F + MathHelper.HALF_PI) * 0.4F) * var2;
		var2 = Math.abs(MathHelper.sin(var1 * 0.6662F + MathHelper.ONE_AND_HALF_PI) * 0.4F) * var2;
		this.leg1.yaw += var4;
		this.leg2.yaw -= var4;
		this.leg3.yaw += var5;
		this.leg4.yaw -= var5;
