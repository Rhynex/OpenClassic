...
public class Quad {
	...
	public Quad(Vertex[] vertices, int u1, int v1, int u2, int v2) {
		this(vertices);
		vertices[0] = vertices[0].create(u2 / 64F - 0.0015625F, v1 / 32F + 0.003125F);
		vertices[1] = vertices[1].create(u1 / 64F + 0.0015625F, v1 / 32F + 0.003125F);
		vertices[2] = vertices[2].create(u1 / 64F + 0.0015625F, v2 / 32F - 0.003125F);
		vertices[3] = vertices[3].create(u2 / 64F - 0.0015625F, v2 / 32F - 0.003125F);
	}
