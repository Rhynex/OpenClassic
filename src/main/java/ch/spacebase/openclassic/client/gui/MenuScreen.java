...
public class MenuScreen extends GuiScreen {
	...
	public void onOpen() {
		this.clearWidgets();
		this.attachWidget(new Button(0, this.getWidth() / 2 - 200, this.getHeight() / 2 - 96, this, OpenClassic.getGame().getTranslator().translate("gui.menu.options")));
		this.attachWidget(new Button(1, this.getWidth() / 2 - 200, this.getHeight() / 2 - 48, this, OpenClassic.getGame().getTranslator().translate("gui.menu.main-menu")));
		this.attachWidget(new Button(2, this.getWidth() / 2 - 200, this.getHeight() / 2 + 120, this, OpenClassic.getGame().getTranslator().translate("gui.menu.back")));
	}
	...
	public void render() {
		...
		RenderHelper.getHelper().renderText(OpenClassic.getGame().getTranslator().translate("gui.menu.title"), this.getWidth() / 2, 80);
		super.render();
	}
}
