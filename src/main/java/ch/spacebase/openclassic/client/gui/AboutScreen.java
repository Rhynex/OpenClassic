...
public class AboutScreen extends GuiScreen {
	...
	public void onOpen() {
		...
		this.attachWidget(WidgetFactory.getFactory().newButton(1, this.getWidth() / 2 - 100, this.getHeight() / 6 + 120 + 12, this, OpenClassic.getGame().getTranslator().translate("gui.back")));
